...
To update it, change the input and press update user button.
...
Once a user is successfully added and set active, a connection to the heart rate sensor can be established and heart rate streaming can be started.
...
\section{Evaluation}
The fulfillment of the requirements and standards outlined in the requirements analysis should be used as an assessment metric to determine if the system and its functions have achieved their primary purpose in alignment with the research project's goals. 
